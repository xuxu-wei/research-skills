...
metadata:
  hermes:
    tags: [research, methodology, statistics, preflight, feasibility-check, endpoint, metric, study-design]
    category: research
    related_skills:
...
- user constraints such as time, resources, ethics, privacy, regulation, or collaboration;
...
- `references/feasibility-blockers.md`：定义样本量、数据可得性、伦理、资源等维度的可行性阻断检查。
