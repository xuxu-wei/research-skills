...
- input-brief.md / argument-skeleton.md / draft-v{N}.md / draft-v{N}-paragraph-map.md / claim-ledger.md / claim-evidence-matrix.md / target-outlet-profile.md / existing-discourse-baseline.md
...
## Constraints
Do NOT revise. Cite specific paragraph numbers. If discourse baseline missing, mark Novelty provisional.
```
...
## Readiness
"ready for submission" only if NO unresolved substantive issues. "ready for outlet targeting" if Generic Profile.
```
