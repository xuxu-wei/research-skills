...
`06_revisions/06_revisions/round-NNN/revision-plan-rNNN.md` must contain issue IDs, action strategy, body-integration strategy, risk, owner, and expected artifact.

`07_panel/panel-summary.md` must retain individual reviewer issue IDs and mark consensus, severity, and route.
