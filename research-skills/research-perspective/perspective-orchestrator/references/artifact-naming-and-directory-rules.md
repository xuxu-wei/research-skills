...
<workspace>/research-perspective-projects/<project-slug>/
  ...
  01_claims/      # claim ledger and claim change records
  02_evidence/    # claim-evidence matrix, limitations, references
  03_skeletons/   # argument skeleton and paragraph maps
...
```text
05_evaluations/perspective-v001-evaluation.md
05_evaluations/perspective-v002-re-evaluation.md
