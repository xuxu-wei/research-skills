...
metadata:
  hermes:
    tags: [research-proposal, final-package, assembly, proposal, review-summary, handoff]
    related_skills:
...
7. State final status: ready for human submission review, minor revision pending, major revision required, blocked, or partial.
...
- Do not mark a package ready for submission when latest changed proposal/SAP versions lack required independent evaluation.
