...
- Every machine-readable artifact includes `schema_version`, `artifact_id`, `source_skill`, `status`, and lineage fields when applicable.
...
article_readiness_report:
  ...
  minimum_inputs_present:
    ...
    ethics_info: true | false | not_applicable
...
article_evaluation:
  ...
  draft_version: 1
  independence_status: true_isolated | inline_degraded | invalid
  dimension_scores:
...
panel_report:
  ...
  draft_ref: "06_drafts/manuscript-v001.md"
  reviewer_isolation_status: true_isolated | inline_degraded
  reviewers: []
...
submission_package:
  ...
  isolation_gate:
    ...
    status_cap_if_unmet: ready_for_author_check
