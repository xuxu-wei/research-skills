...
- `minimum_inputs_present`: explicit true/false/not_applicable flags for research question, design, results, methods, ethics, figures/tables, and references.
...
- Human/animal ethics missingness is blocking unless the study is clearly exempt or uses public secondary data.
