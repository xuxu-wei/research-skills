...
metadata:
  hermes:
    tags: [research-article, context, normalization, study-type, reporting-standard]
    related_skills:
...
context_brief:
  ...
  ethics_and_governance:
    ethics_approval: true | false | not_reported
    informed_consent: true | false | not_applicable | not_reported
    data_sharing_statement: "" | missing
    funding_sources: []
    conflicts_of_interest: "" | not_reported
