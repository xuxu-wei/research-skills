...
RELATED_SKILL_ADDITIONS = {
    ...
    "research-idea-orchestrator": {"idea-narrative-assessor", "medical-journal-review"},
    "idea-portfolio-assembler": {"medical-journal-review"},
    "academic-language-assessor": {"idea-narrative-assessor", "research-idea-orchestrator"},
}
...
WORKFLOW_EDGES = [
    ...
    ("idea", "research-idea-orchestrator", "idea-narrative-assessor", "delegated", "scientific_revision_frozen_or_editorial_repair_completed", "one_current_idea_dossier_and_reader_handoff_or_old_new_register_delta", "narrative_assessment_and_yaml_repair_plan_or_content_preservation_report", "independent_review_pending"),
...
WORKFLOW_STATE_POLICY = {
    ...
    "lifecycle_transitions": [
        ...
        {"from": "artifact_frozen", "to": "editorial_review_pending", "trigger": "idea_editorial_readiness_dispatched"},
        {"from": "editorial_review_pending", "to": "editorial_revision_required", "trigger": "idea_editorial_revision_requested"},
        ...
        {"from": "editorial_revision_required", "to": "new_idea_required", "trigger": "identity_drift_detected"},
        {"from": "editorial_revision_required", "to": "artifact_frozen", "trigger": "preserved_editorial_version_created"},
        {"from": "editorial_review_pending", "to": "artifact_frozen", "trigger": "idea_editorial_readiness_passed"},
...
PACKAGE_INPUT_CONTRACTS = {
    "idea": {
        ...
        "required_inputs": [
            ...
            {"artifact_role": "narrative_assessment", "source_skill": "idea-narrative-assessor", "current_primary_lineage": True, "count_must_equal_current_idea_dossier_count": True},
            ...
            {"artifact_role": "content_preservation_report", "source_skill": "idea-narrative-assessor", "current_primary_lineage": True, "required_when_condition": "editorial_repair_occurred", "count_per_editorially_repaired_current_dossier": 1},
            ...
            {"artifact_role": "narrative_repair_plan", "source_skill": "idea-narrative-assessor", "minimum_count": 0, "include_all_created": True},
...
SCENARIO_EVAL_CONTRACT = {
    ...
    "runtime_artifact_role_contract": {
        ...
        "actor_output_roles_by_skill": {
            ...
            "idea-narrative-assessor": ["narrative_assessment", "narrative_repair_plan", "content_preservation_report"],
            "medical-journal-review": ["medical_journal_review_report"],
            "methodology-statistics-preflight": ["preflight_report"],
...
ARTIFACT_COMPLETENESS_POLICY = {
    ...
    "idea_editorial_readiness_contract": {
        ...
        "parallel_reviewers": ["idea-narrative-assessor", "academic-language-assessor"],
