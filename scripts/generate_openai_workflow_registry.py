...
SKILL_IO_OVERRIDES = {
    "proposal-drafter": (
        "approved_context_evidence_background_selection_content_plan_or_revision_authority",
        "proposal_background_path_options_proposal_content_plan_v2_or_versioned_complete_proposal",
    ),
    "multi-path-idea-generator": (
...
WORKFLOW_EDGES = [
    ...
    ("proposal", "proposal-orchestrator", "proposal-drafter", "delegated", "background_path_options_required", "frozen_context_readiness_evidence_reader_constraints_and_research_content_route_problem_map", "proposal_background_path_options_v1_and_human_selection_stop_or_one_path_clarification", "clarification_required"),
    ("proposal", "proposal-orchestrator", "proposal-drafter", "delegated", "background_path_selection_recorded_or_user_explicit_or_binding_constraint", "frozen_context_evidence_reader_constraints_and_selection_or_bypass_authority", "proposal_content_plan_v2_yaml", "planning_blocked"),
...
WORKFLOW_STATE_POLICY = {
    ...
    "resume_policy": {
        ...
        "human_background_path_selection_required": "planning",
    },
    "version_gate": {
    ...
    "lifecycle_transitions": [
        ...
        {"from": "preprocessing", "to": "planning", "trigger": "proposal_readiness_passed_and_background_planning_started"},
        {"from": "preprocessing", "to": "artifact_frozen", "trigger": "versioned_artifact_created"},
        {"from": "planning", "to": "human_background_path_selection_required", "trigger": "proposal_background_path_options_frozen"},
        {"from": "planning", "to": "human_background_path_selection_required", "trigger": "sole_background_path_requires_user_acceptance_or_constraint"},
        {"from": "human_background_path_selection_required", "to": "planning", "trigger": "user_background_path_selected_and_selection_artifact_frozen"},
        {"from": "human_background_path_selection_required", "to": "planning", "trigger": "user_requests_coherent_new_candidate_round"},
        {"from": "human_background_path_selection_required", "to": "clarification_stop", "trigger": "user_rejects_all_without_new_organizing_constraint"},
        {"from": "human_background_path_selection_required", "to": "planning", "trigger": "user_accepts_sole_background_path_and_selection_artifact_frozen"},
        {"from": "human_background_path_selection_required", "to": "planning", "trigger": "user_supplies_additional_background_organizing_constraint"},
        {"from": "planning", "to": "artifact_frozen", "trigger": "proposal_content_plan_v2_frozen"},
        {"from": "artifact_frozen", "to": "writing", "trigger": "full_proposal_writer_dispatched"},
        {"from": "writing", "to": "artifact_frozen", "trigger": "complete_proposal_version_frozen"},
...
WORKFLOW_STATE_MACHINES = {
    ...
    "proposal": {
        ...
        "entry_gates": {
            "standard": ["context_frozen", "readiness_passed", "background_path_authority_frozen", "proposal_content_plan_frozen", "proposal_versioned"],
        ...
        "scenario_entry_gate_contracts": {
            "standard": {
                ...
                "background_path_authority_frozen": {
                    "authority_modes": {
                        "option_selection": {
                            "required_artifact_roles": ["proposal_background_path_options", "proposal_background_path_selection"],
                            "selection_source": "user",
                        },
                        "sole_path_acceptance": {
                            "required_artifact_roles": ["proposal_background_path_selection"],
                            "forbidden_artifact_roles": ["proposal_background_path_options"],
                            "selection_source": "user",
                        },
                        "bypass": {
                            "required_artifact_roles": ["proposal_content_plan"],
                            "forbidden_artifact_roles": ["proposal_background_path_options", "proposal_background_path_selection"],
                            "selection_sources": ["user_explicit", "binding_constraint"],
                            "authority_recorded_in": "proposal_content_plan",
                            "required_schema": "proposal-content-plan.v2",
                        },
                    },
                },
                "proposal_content_plan_frozen": {
                    "artifact_roles": ["proposal_content_plan"],
                    "required_schema": "proposal-content-plan.v2",
                },
...
PACKAGE_INPUT_CONTRACTS = {
    ...
    "proposal": {
        "allowed_roles": ["proposal_context", "readiness_report", "proposal_background_path_options", "proposal_background_path_selection", "proposal_content_plan", "proposal", "protected_content_register", "narrative_assessment", "narrative_repair_plan", "language_assessment_report", "editorial_repair_writer_brief", "content_preservation_report", "evaluation_report", "preflight_report", "sap", "panel_report", "candidate_journal_match_brief", "medical_journal_review_report", "revision_plan", "response_to_reviewers", "revision_delta"],
        "required_inputs": [
            ...
            {"artifact_role": "proposal_background_path_options", "source_skill": "proposal-drafter", "minimum_count": 1, "required_when_condition": "standard_default_candidate_route", "schema_version": "proposal-background-path-options.v1", "include_all_created": True},
            {"artifact_role": "proposal_background_path_selection", "source_skill": "proposal-orchestrator", "count": 1, "required_when_condition": "background_options_selected_or_sole_path_accepted", "schema_version": "proposal-background-path-selection.v1"},
            {"artifact_role": "proposal_content_plan", "source_skill": "proposal-drafter", "count": 1, "required_when_condition": "new_full_proposal", "allowed_schema_versions": ["proposal-content-plan.v1", "proposal-content-plan.v2"], "required_schema_when_new_full_proposal": "proposal-content-plan.v2", "fresh_planner_required_when_new_full_proposal": True},
...
PANEL_CONTRACTS = {
    ...
    "proposal": {
        ...
        "mode_forbidden_input_roles": {
            "blind_mock_review": ["proposal_context", "readiness_report", "evidence_map", "proposal_background_path_options", "proposal_background_path_selection", "proposal_content_plan", "evaluation_report", "revision_plan", "revision_delta", "response_to_reviewers", "panel_report"],
...
SCENARIO_EVAL_CONTRACT = {
    ...
    "runtime_artifact_role_contract": {
        ...
        "actor_output_roles_by_skill": {
            ...
            "proposal-orchestrator": ["proposal_background_path_selection", "minimal_workflow_state", "continuation_brief"],
            ...
            "proposal-drafter": ["proposal_background_path_options", "proposal_content_plan", "proposal", "response_to_reviewers", "revision_delta"],
            "sap-writer": ["sap"],
...
ARTIFACT_COMPLETENESS_POLICY = {
    ...
    "proposal_background_argumentation_contract": {
        "default_sequence": [
            "readiness",
        ...
        "options_artifact": {
            "role": "proposal_background_path_options",
            "schema": "proposal-background-path-options.v1",
            "path": "04_drafts/proposal-background-path-options-vNNN.yaml",
            "minimum_options": 2,
            "maximum_options": 3,
            "materially_distinct_and_evidence_supportable": True,
            "fixed_systematic_plus_progressive_mix_required": False,
            "score_forbidden": True,
            "recommendation": None,
            "ranking": None,
            "selection_status": "human_background_path_selection_required",
            "only_one_feasible_path_route": "user_acceptance_creates_frozen_sole_path_selection_or_additional_organizing_constraint_starts_new_round",
            "fabricated_alternative_forbidden": True,
        },
        "selection_artifact": {
            "role": "proposal_background_path_selection",
            "schema": "proposal-background-path-selection.v1",
            "path": "04_drafts/proposal-background-path-selection-vNNN.yaml",
            "source_skill": "proposal-orchestrator",
            "selection_source": "user",
            "required_fields": [
                "selection_mode",
                "user_authorization_text",
                "user_requested_local_modifications",
                "rejected_option_ids",
            ],
            "selection_modes": {
                "option_selection": {
                    "required_fields": ["selected_option_id", "options_ref"],
                    "accepted_sole_path": None,
                    "options_ref_must_resolve_to_packaged_options_artifact": True,
                    "selected_option_id_must_resolve_exactly_once_in_referenced_options": True,
                },
                "sole_path_acceptance": {
                    "required_fields": ["accepted_sole_path"],
                    "selected_option_id": None,
                    "options_ref": None,
                    "user_acceptance_required": True,
                    "accepted_outline_must_be_functionally_complete": True,
                },
            },
            "hybrid_request_route": "new_candidate_background_path_round",
            "direct_option_splicing_to_writer_forbidden": True,
        },
        "selection_bypass_sources": ["user_explicit", "binding_constraint"],
        "content_plan": {
            "role": "proposal_content_plan",
            "required_schema_for_new_full_proposal": "proposal-content-plan.v2",
            "legacy_schema": "proposal-content-plan.v1",
            "legacy_v1_readable": True,
            "unwritten_v1_requires_fresh_v2_planner": True,
            "existing_draft_targeted_revision_requires_migration": False,
            "required_background_argumentation_fields": [
                "selection_source",
                "selection_mode",
                "user_authorization_text",
                "selected_path_ref",
            ...
            "bypass_authority": {
                "selection_mode": "bypass",
                "selection_artifact_forbidden": True,
                "user_explicit_requires_user_authorization_text": True,
                "binding_constraint_requires_selected_path_ref": True,
            },
            "selection_authority_binding": {
                "selected_path_ref_must_resolve_to_frozen_selection_artifact": True,
                "user_authorization_text_must_match_selection_exactly": True,
            },
        },
        "instance_separation": {
            "roles": ["candidate_planner", "formal_planner", "full_writer"],
            "pairwise_distinct_instance_ids_required": True,
        },
        "writing_modes": {
            "systematic": "every_current_status_unit_lands_on_project_component_and_units_cover_research_content",
            "progressive": "headings_entry_claims_and_exit_handoffs_form_recoverable_chain_mapping_research_route_to_project",
        },
        "default_chinese_headings_without_binding_template": ["1.1 选题价值", "1.2 国内外研究现状"],
        "default_chinese_synthesis_transition": "综上",
        "other_languages_or_binding_templates_use_functional_equivalence": True,
        "synthesis_forbids_new_evidence_or_later_method_detail_duplication": True,
        "superlatives_require_matching_evidence_strength": True,
        "theory_led_projects_use_scientific_or_methodological_bottleneck": True,
        "blind_final_evaluator": {
            "allowed_project_artifacts": ["current_complete_proposal"],
            "forbidden_project_artifact_roles": [
                "proposal_background_path_options",
                "proposal_background_path_selection",
                "proposal_content_plan",
            ],
            "checks": [
                "opening_establishes_value_problem_and_core_constraint",
                "systematic_units_land_on_project_components_when_applicable",
                "progressive_chain_maps_research_route_when_applicable",
                "synthesis_completes_gap_to_project_route_innovation_and_significance_handoff",
            ],
            "fixed_mode_names_headings_numbering_or_literal_transition_are_hard_gates": False,
            "functional_absence_or_gap_to_rationale_break_is_clarity_failure": True,
        },
    },
    "proposal_content_plan_role": "proposal_content_plan",
    "proposal_content_plan_required_before_new_full_draft": True,
    "proposal_content_plan_required_schema_before_new_full_draft": "proposal-content-plan.v2",
    ...
    "fresh_re_evaluation": {
        ...
        "forbidden": ["prior_artifact", "planning_or_context_artifact", "proposal_background_path_options", "proposal_background_path_selection", "proposal_content_plan", "scientific_audit", "narrative_or_language_report", "repair_plan_or_brief", "protected_content_register", "content_preservation_report", "revision_delta", "anonymous_must_fix_list", "prior_report", "prior_score", "prior_decision"],
