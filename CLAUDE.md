...
```bash
python scripts/audit_research_workflows.py      # Cross-package consistency audit
python scripts/codex_plugin_converter.py --mode flatten   # Generate skills-flatten/
python scripts/codex_plugin_converter.py --mode codex --install  # Build and install Codex plugin
```
