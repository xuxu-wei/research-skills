...
source, reads any other project artifact, opens any URL before freezing the
evaluation, opens a non-official or non-scope/article-type URL afterward, sees
history/scores/decisions,
evaluates a partial dossier, cannot resolve the bound artifact ID/version/path,
omits required chain/claim
