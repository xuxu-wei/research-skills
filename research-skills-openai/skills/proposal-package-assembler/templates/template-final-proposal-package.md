...
## 3. Included Materials
| Material | Path / Summary | Status |
|---|---|---|
| Proposal |  |  |
| Context brief |  |  |
| Readiness report |  |  |
...
## 4. Readiness and Evaluation Summary
- Readiness outcome:
- Latest proposal evaluation decision:
- Hard gate status:
- Fatal flaws:
