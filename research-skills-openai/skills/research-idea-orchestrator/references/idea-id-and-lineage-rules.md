...
- Bind each version to its exact path, SHA-256, `based_on`, round, and change
...
Reviewer briefs bind the current dossier ID, version, path, and digest. A stale
or mismatched binding cannot qualify the node.
