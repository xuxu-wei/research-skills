# Portfolio Assembly Failure Report
...
## 2. Required Upstream Action

| Missing / invalid item | Required action | Suggested skill |
|---|---|---|
...
Portfolio assembly is paused until the required inputs are supplied or corrected.
